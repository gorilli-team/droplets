      ...
      <div className="min-h-screen bg-gray-900 text-white">
        ...
        <section className="relative flex items-center justify-center h-screen bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500">
          ...
          <div className="relative z-10 text-center max-w-4xl px-6">
            ...
            <p className="mt-6 text-2xl text-gray-200">
              Get access to the top DeFi investors' portfolios and invest like a Pro accessing their
        ...
        <section id="about" className="py-24 bg-gray-800">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-gray-300 text-xl leading-relaxed max-w-3xl mx-auto">
              At Droplets, we are revolutionizing the way you interact with the decentralized web.
              Our platform is designed for creators, innovators, and visionaries. With seamless
              integration, secure transactions, and a community-first approach, we are building the
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 text-center px-6">
            <div className="p-10 bg-gray-900 rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300">
              ...
              <p className="mt-4 text-gray-400">
                Our platform is optimized for speed, ensuring you experience Web3 like never before.
              </p>
            </div>
            <div className="p-10 bg-gray-900 rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300">
              <h3 className="text-2xl font-semibold text-white">Secure & Reliable</h3>
              <p className="mt-4 text-gray-400">
                Built with the highest security standards, your assets are always safe with us.
              </p>
            </div>
            <div className="p-10 bg-gray-900 rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300">
              <h3 className="text-2xl font-semibold text-white">Community Driven</h3>
              <p className="mt-4 text-gray-400">
                We put our community first, ensuring that every voice is heard and valued.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 bg-gray-900">
          <div className="max-w-6xl mx-auto text-center px-6">
            <h2 className="text-4xl font-bold mb-10 text-white">Join the Revolution</h2>
            <p className="text-gray-300 text-xl mb-12 max-w-2xl mx-auto">
              Ready to be part of something bigger? Get started with Droplets today and explore the
              endless possibilities of Web3.
            </p>
